...
const BusRoute = ({route}) => {
 ...
 const [modalVisible, setModalVisible] = useState(true);
  //const [modalVisible, setmodalVisible] = useState(false);
    ...
    function bookseat(){
      navigation.navigate("BookedTicket",{routename:routename,busno:busno,drivername:drivername});
    ...
    <View style={{alignSelf:"center",justifyContent:'center',alignItems:"center",marginTop:25}}>
      ...
      <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('ConcessionPage')}>
         <View style={{height:50,width:150,backgroundColor:"orange",borderRadius:10,marginTop:20,alignSelf:"center"}}>
          <Text style={{alignSelf:"center",marginTop:10,fontSize:18,fontWeight:"bold",color:"white"}}>Concession</Text>
         </View>
      </TouchableOpacity>
